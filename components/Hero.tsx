...
export function Hero() {
  return (
    <div
      style={{ height: "80vh" }}
      className=" relative w-full flex flex-col overflow-hidden justify-center bg-black  text-gray-200 px-5 md:px-20 mb-20"
    >
      <div className="w-full md:w-2/4 flex z-50 flex-col gap-5 items-start">
        <h1 className="font-bold text-3xl md:text-5xl ">Get to know Computech</h1>
